...
Begin VB.Form frm_Rpt_EvaCre_03 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "EvaCre_frm_076.frx":000C
            Top             =   60
            Width           =   480
         End
      End
      Begin Threed.SSPanel SSPanel4 
         ...
         Begin VB.CommandButton cmd_Imprim 
            Height          =   585
            Left            =   30
            Picture         =   "EvaCre_frm_076.frx":0316
            Style           =   1  'Graphical
            TabIndex        =   4
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   5340
            Picture         =   "EvaCre_frm_076.frx":0758
            Style           =   1  'Graphical
            TabIndex        =   6
            ToolTipText     =   "Salir"
            Top             =   30
         ...
         Begin VB.CommandButton cmd_ExpExc 
            Height          =   585
            Left            =   630
            Picture         =   "EvaCre_frm_076.frx":0B9A
            Style           =   1  'Graphical
            TabIndex        =   5
   ...
   End
End
Attribute VB_Name = "frm_Rpt_EvaCre_03"
...
Private Sub cmd_ExpExc_Click()
   ...
   Call modmip_gs_Exc_Tramit(21, 3, r_str_CodMod, r_str_PrySel)
...
Private Sub cmd_Imprim_Click()
   ...
   If chk_TipPry.Value = 0 Then
      If chk_CodPry.Value = 0 And chk_CodPry.Enabled = True Then
         Call modmip_gs_Rpt_EvaIns("CRE_EVAHIP_03.RPT", 3, Format(cmb_TipPry.ItemData(cmb_TipPry.ListIndex), "00"), 21, l_arr_CodPry(cmb_CodPry.ListIndex + 1).Genera_Codigo)
      Else
         Call modmip_gs_Rpt_EvaIns("CRE_EVAHIP_03.RPT", 3, Format(cmb_TipPry.ItemData(cmb_TipPry.ListIndex), "00"), 21, "")
      End If
   Else
      Call modmip_gs_Rpt_EvaIns("CRE_EVAHIP_03.RPT", 1, "", 21, "")
   End If
