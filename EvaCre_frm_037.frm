...
Begin VB.Form frm_RecSol_12 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel3 
         ...
         Begin TabDlg.SSTab SSTab2 
            ...
            TabPicture(0)   =   "EvaCre_frm_037.frx":000C
            ...
            TabPicture(1)   =   "EvaCre_frm_037.frx":0028
      ...
      Begin Threed.SSPanel SSPanel2 
         ...
         Begin TabDlg.SSTab SSTab1 
            ...
            TabPicture(6)   =   "EvaCre_frm_037.frx":00F8
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "EvaCre_frm_037.frx":0118
            Top             =   60
            Width           =   480
         End
      End
      ...
      Begin Threed.SSPanel SSPanel39 
         ...
         Begin VB.CommandButton cmd_SolRec 
            Height          =   585
            Left            =   1230
            Picture         =   "EvaCre_frm_037.frx":0422
            Style           =   1  'Graphical
            TabIndex        =   50
         ...
         Begin VB.CommandButton cmd_AprCon 
            Height          =   585
            Left            =   1830
            Picture         =   "EvaCre_frm_037.frx":072C
            Style           =   1  'Graphical
            TabIndex        =   35
         ...
         Begin VB.CommandButton cmd_Excepc 
            Height          =   585
            Left            =   630
            Picture         =   "EvaCre_frm_037.frx":0A36
            Style           =   1  'Graphical
            TabIndex        =   21
         ...
         Begin VB.CommandButton cmd_RecSol 
            Height          =   585
            Left            =   2430
            Picture         =   "EvaCre_frm_037.frx":0D40
            Style           =   1  'Graphical
            TabIndex        =   20
            ToolTipText     =   "Aprobación de Instancia"
            Top             =   30
            Width           =   585
         End
         Begin VB.CommandButton cmd_NueObs 
            Height          =   585
            Left            =   30
            Picture         =   "EvaCre_frm_037.frx":104A
            Style           =   1  'Graphical
            TabIndex        =   18
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   10920
            Picture         =   "EvaCre_frm_037.frx":148C
            Style           =   1  'Graphical
            TabIndex        =   17
            ToolTipText     =   "Salir"
            Top             =   30
   ...
   End
End
Attribute VB_Name = "frm_RecSol_12"
...
Private Sub cmd_AprCon_Click()
   ...
   modgen_g_str_Mail_Asunto = "REGISTRO DE SOLICITUD - APROBACION CONDICIONADA (" & Format(CDate(moddat_g_str_FecSis), "dd/mm/yyyy") & " - " & Format(Time, "hh:mm:ss") & ")"
...
Private Sub cmd_Excepc_Click()
   ...
   If moddat_g_int_FlgAct_1 = 2 Then
      ...
      'Enviando Correo Electrónico
      modgen_g_str_Mail_Asunto = "REGISTRO DE SOLICITUD - EXCEPCION (" & Format(CDate(moddat_g_str_FecSis), "dd/mm/yyyy") & " - " & Format(Time, "hh:mm:ss") & ")"
...
Private Sub cmd_RecSol_Click()
   ...
   'Enviando Correo Electrónico
   modgen_g_str_Mail_Asunto = "REGISTRO DE SOLICITUD - APROBACION (" & Format(CDate(moddat_g_str_FecSis), "dd/mm/yyyy") & " - " & Format(Time, "hh:mm:ss") & ")"
