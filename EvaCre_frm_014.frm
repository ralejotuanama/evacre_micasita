   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel7 
         ...
         Begin VB.CommandButton cmd_Grabar 
            Height          =   675
            Left            =   10080
            Picture         =   "EvaCre_frm_014.frx":000C
            Style           =   1  'Graphical
            TabIndex        =   6
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   675
            Left            =   10800
            Picture         =   "EvaCre_frm_014.frx":0316
            Style           =   1  'Graphical
            TabIndex        =   5
            ToolTipText     =   "Salir"
            Top             =   60
      ...
      Begin Threed.SSPanel SSPanel2 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "EvaCre_frm_014.frx":0758
            Top             =   60
            Width           =   480
         End
      End
...
Private Sub cmd_Acc_BusEmp_Click()
   If cmb_Acc_TipDoc.ListIndex = -1 Then
      MsgBox "Debe seleccionar el Tipo de Documento.", vbExclamation, modgen_g_con_AteCli
      Call gs_SetFocus(cmb_Acc_TipDoc)
      Exit Sub
   End If
   
   If Len(Trim(txt_Acc_NumDoc.Text)) = 0 Then
      MsgBox "Debe ingresar el Número de Documento.", vbExclamation, modgen_g_con_AteCli
...
Private Sub cmd_BorAct_Click()
   If MsgBox("¿Está seguro de eliminar la actividad?", vbQuestion + vbYesNo + vbDefaultButton2, modgen_g_con_AteCli) <> vbYes Then
      Exit Sub
   End If
...
Private Sub cmd_Ind_Direcc_Click()
   cmb_Ind_TipVia.ListIndex = frm_MntCli_02.cmb_TipVia.ListIndex
   txt_Ind_NomVia.Text = frm_MntCli_02.txt_NomVia.Text
   txt_Ind_Numero.Text = frm_MntCli_02.txt_Numero.Text
   txt_Ind_Interi.Text = frm_MntCli_02.txt_Interi.Text
   cmb_Ind_TipZon.ListIndex = frm_MntCli_02.cmb_TipZon.ListIndex
   txt_Ind_NomZon.Text = frm_MntCli_02.txt_NomZon.Text
   
   cmb_Ind_DptDir.ListIndex = frm_MntCli_02.cmb_DptDir.ListIndex
   
   Call moddat_gs_Carga_Provin(cmb_Ind_PrvDir, Format(cmb_Ind_DptDir.ItemData(cmb_Ind_DptDir.ListIndex), "00"))
   cmb_Ind_PrvDir.ListIndex = frm_MntCli_02.cmb_PrvDir.ListIndex
         
   Call moddat_gs_Carga_Distri(cmb_Ind_DstDir, Format(cmb_Ind_DptDir.ItemData(cmb_Ind_DptDir.ListIndex), "00"), Format(cmb_Ind_PrvDir.ItemData(cmb_Ind_PrvDir.ListIndex), "00"))
   cmb_Ind_DstDir.ListIndex = frm_MntCli_02.cmb_DstDir.ListIndex
   
   txt_Ind_Telef1.Text = frm_MntCli_02.txt_Telefo.Text
...
Private Function ff_Valida_Dep() As Integer
   ...
   If Len(Trim(pnl_Dep_FlgEmp.Caption)) = 0 Then
      MsgBox "Debe buscar la empresa en el Maestro de Empresas.", vbExclamation, modgen_g_con_AteCli
      Call gs_SetFocus(cmd_Dep_BusEmp)
      Exit Function
   End If
   ...
   If txt_Dep_GirCom.Enabled Then
      If Len(Trim(txt_Dep_GirCom.Text)) = 0 Then
         MsgBox "Debe ingresar el Giro Comercial.", vbExclamation, modgen_g_con_AteCli
         Call gs_SetFocus(txt_Dep_GirCom)
         Exit Function
      End If
   End If
   ...
   If Len(Trim(txt_Dep_TeleRH.Text)) = 0 And Len(Trim(txt_Dep_AnexRH.Text)) = 0 Then
      MsgBox "Ingrese el Teléfono o el Anexo de Recuros Humanos.", vbExclamation, modgen_g_con_AteCli
      Call gs_SetFocus(txt_Dep_TeleRH)
      Exit Function
   End If
   ...
   If cmb_Dep_NomCar.ListIndex = -1 Then
      MsgBox "Seleccione el Cargo.", vbExclamation, modgen_g_con_AteCli
      Call gs_SetFocus(cmb_Dep_NomCar)
      Exit Function
   End If
   ...
   If txt_Dep_NomCar.Enabled Then
      If Len(Trim(txt_Dep_NomCar.Text)) = 0 Then
         MsgBox "Debe ingresar el Cargo.", vbExclamation, modgen_g_con_AteCli
         Call gs_SetFocus(txt_Dep_NomCar)
         Exit Function
      End If
   End If
   ...
   If Len(Trim(txt_Dep_NomAre.Text)) = 0 Then
      MsgBox "Debe ingresar el Area.", vbExclamation, modgen_g_con_AteCli
      Call gs_SetFocus(txt_Dep_NomAre)
      Exit Function
   End If
...
Private Function ff_Valida_Com() As Integer
   ...
   If cmb_Com_TipDoc.ItemData(cmb_Com_TipDoc.ListIndex) = 2 Then
      If CDbl(ipp_Com_AlqMen.Text) = 0 Then
         MsgBox "Ingrese el Importe de Alquiler Mensual.", vbExclamation, modgen_g_con_AteCli
         Call gs_SetFocus(ipp_Com_AlqMen)
         Exit Function
      End If
   
      If Len(Trim(txt_Com_NomArr.Text)) = 0 Then
         MsgBox "Ingrese el Nombre del Arrendador.", vbExclamation, modgen_g_con_AteCli
         Call gs_SetFocus(txt_Com_NomArr)
         Exit Function
      End If
   
      If Len(Trim(txt_Com_Tl1Arr.Text)) = 0 Then
         MsgBox "Ingrese el Teléfono del Arrendador.", vbExclamation, modgen_g_con_AteCli
...
Private Function ff_Valida_Ind() As Integer
   ...
   If cmb_Ind_ConLoc.ListIndex = -1 Then
      MsgBox "Seleccione si tiene Contrato de Locación de Servicios.", vbExclamation, modgen_g_con_AteCli
      Call gs_SetFocus(cmb_Ind_ConLoc)
      Exit Function
   End If
   ...
   If cmb_Ind_ConLoc.ItemData(cmb_Ind_ConLoc.ListIndex) = 1 Then
      If cmb_Ind_TDoEmp.ListIndex = -1 Then
         MsgBox "Seleccione el Tipo de Documento de la Empresa donde tiene Contrato de Locación.", vbExclamation, modgen_g_con_AteCli
         Call gs_SetFocus(cmb_Ind_TDoEmp)
         Exit Function
      End If
...
Private Function ff_Valida_Ren() As Integer
   ...
   If Len(Trim(txt_Ren_Direc1.Text)) = 0 Then
      MsgBox "Ingrese la Dirección de la Propiedad Nro. 1.", vbExclamation, modgen_g_con_AteCli
      Call gs_SetFocus(txt_Ren_Direc1)
      Exit Function
   End If
   
   If Len(Trim(txt_Ren_NomAr1.Text)) = 0 Then
      MsgBox "Ingrese la Nombre del Arrendatario de la Propiedad Nro. 1.", vbExclamation, modgen_g_con_AteCli
      Call gs_SetFocus(txt_Ren_NomAr1)
      Exit Function
   End If
   
   If Len(Trim(txt_Ren_Tele11.Text)) = 0 Then
      MsgBox "Ingrese el Teléfono del Arrendatario de la Propiedad Nro. 1.", vbExclamation, modgen_g_con_AteCli
      Call gs_SetFocus(txt_Ren_Tele11)
      Exit Function
   End If
   
   If CDbl(ipp_Ren_AlqMe1.Text) = 0 Then
      MsgBox "Ingrese el Importe de Alquiler Mensual de la Propiedad Nro. 1.", vbExclamation, modgen_g_con_AteCli
   ...
   If chk_Alqui2.Value = 1 Then
      If Len(Trim(txt_Ren_Direc2.Text)) = 0 Then
         MsgBox "Ingrese la Dirección de la Propiedad Nro. 2.", vbExclamation, modgen_g_con_AteCli
         Call gs_SetFocus(txt_Ren_Direc2)
         Exit Function
      End If
      
      If Len(Trim(txt_Ren_NomAr2.Text)) = 0 Then
         MsgBox "Ingrese la Nombre del Arrendatario de la Propiedad Nro. 2.", vbExclamation, modgen_g_con_AteCli
         Call gs_SetFocus(txt_Ren_NomAr2)
         Exit Function
      End If
      
      If Len(Trim(txt_Ren_Tele12.Text)) = 0 Then
         MsgBox "Ingrese el Teléfono del Arrendatario de la Propiedad Nro. 2.", vbExclamation, modgen_g_con_AteCli
         Call gs_SetFocus(txt_Ren_Tele12)
         Exit Function
      End If
      
      If CDbl(ipp_Ren_AlqMe2.Text) = 0 Then
         MsgBox "Ingrese el Importe de Alquiler Mensual de la Propiedad Nro. 2.", vbExclamation, modgen_g_con_AteCli
   ...
   If chk_Alqui3.Value = 1 Then
      If Len(Trim(txt_Ren_Direc3.Text)) = 0 Then
         MsgBox "Ingrese la Dirección de la Propiedad Nro. 3.", vbExclamation, modgen_g_con_AteCli
         Call gs_SetFocus(txt_Ren_Direc2)
         Exit Function
      End If
      
      If Len(Trim(txt_Ren_NomAr3.Text)) = 0 Then
         MsgBox "Ingrese la Nombre del Arrendatario de la Propiedad Nro. 3.", vbExclamation, modgen_g_con_AteCli
         Call gs_SetFocus(txt_Ren_NomAr3)
         Exit Function
      End If
      
      If Len(Trim(txt_Ren_Tele13.Text)) = 0 Then
         MsgBox "Ingrese el Teléfono del Arrendatario de la Propiedad Nro. 3.", vbExclamation, modgen_g_con_AteCli
         Call gs_SetFocus(txt_Ren_Tele13)
         Exit Function
      End If
      
      If CDbl(ipp_Ren_AlqMe3.Text) = 0 Then
         MsgBox "Ingrese el Importe de Alquiler Mensual de la Propiedad Nro. 3.", vbExclamation, modgen_g_con_AteCli
