   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel11 
         ...
         Begin VB.CommandButton cmd_GraObs 
            Height          =   675
            Left            =   10140
            Picture         =   "EvaCre_frm_024.frx":00B8
            Style           =   1  'Graphical
            TabIndex        =   5
         ...
         Begin VB.CommandButton cmd_CanObs 
            Height          =   675
            Left            =   10830
            Picture         =   "EvaCre_frm_024.frx":04FA
            Style           =   1  'Graphical
            TabIndex        =   6
         ...
         Begin VB.CommandButton cmd_NueObs 
            Height          =   675
            Left            =   9450
            Picture         =   "EvaCre_frm_024.frx":0804
            Style           =   1  'Graphical
            TabIndex        =   4
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "EvaCre_frm_024.frx":0C4E
            Top             =   60
            Width           =   480
         End
      End
      Begin Threed.SSPanel SSPanel36 
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   675
            Left            =   10830
            Picture         =   "EvaCre_frm_024.frx":0F58
            Style           =   1  'Graphical
            TabIndex        =   9
            ToolTipText     =   "Salir"
            Top             =   30
         ...
         Begin VB.CommandButton cmd_Aprueb 
            Height          =   675
            Left            =   9450
            Picture         =   "EvaCre_frm_024.frx":139A
            Style           =   1  'Graphical
            TabIndex        =   7
         ...
         Begin VB.CommandButton cmd_Rechaz 
            Height          =   675
            Left            =   10140
            Picture         =   "EvaCre_frm_024.frx":16A4
            Style           =   1  'Graphical
            TabIndex        =   8
      ...
      Begin Threed.SSPanel SSPanel39 
         ...
         Begin VB.CommandButton cmd_SimCre 
            Height          =   675
            Left            =   30
            Picture         =   "EvaCre_frm_024.frx":1AE6
            Style           =   1  'Graphical
            TabIndex        =   49
         ...
         Begin VB.CommandButton cmd_CalIng 
            Height          =   675
            Left            =   10170
            Picture         =   "EvaCre_frm_024.frx":1DF0
            Style           =   1  'Graphical
            TabIndex        =   48
         ...
         Begin VB.CommandButton cmd_DatCli 
            Height          =   675
            Left            =   720
            Picture         =   "EvaCre_frm_024.frx":20FA
            Style           =   1  'Graphical
            TabIndex        =   47
         ...
         Begin VB.CommandButton cmd_Evalua 
            Height          =   675
            Left            =   10830
            Picture         =   "EvaCre_frm_024.frx":2404
            Style           =   1  'Graphical
            TabIndex        =   0
            ToolTipText     =   "Cálculo de Condiciones del Préstamo"
            Top             =   30
            Width           =   675
         End
...
Private Sub cmd_Aprueb_Click()
   ...
   modgen_g_str_Mail_Asunto = "APROBACION DE EVALUACION CREDITICIA (" & Format(CDate(moddat_g_str_FecSis), "dd/mm/yyyy") & " - " & Format(Time, "hh:mm:ss") & ")"
   ...
   modgen_g_str_Mail_Mensaj = modgen_g_str_Mail_Mensaj & txt_ObsEva.Text
...
Private Sub cmd_GraObs_Click()
   ...
   If Not moddat_gf_Inserta_SegDet(moddat_g_str_NumSol, 21, 21, CStr(grd_LisObs.Rows + 1), txt_Observ.Text, 1, 0) Then
      Exit Sub
   End If
   ...
   'Enviando Correo Electrónico
   modgen_g_str_Mail_Asunto = "OBSERVACION EN EVALUACION CREDITICIA (" & Format(CDate(moddat_g_str_FecSis), "dd/mm/yyyy") & " - " & Format(Time, "hh:mm:ss") & ")"
   ...
   Call fs_Envia_CorEle(modgen_g_str_Mail_Asunto, modgen_g_str_Mail_Mensaj, 0)
...
Private Sub cmd_Rechaz_Click()
   ...
   If moddat_g_int_MotRec > 0 Then
      ...
      modgen_g_str_Mail_Asunto = "RECHAZO DE EVALUACION CREDITICIA (" & Format(CDate(moddat_g_str_FecSis), "dd/mm/yyyy") & " - " & Format(Time, "hh:mm:ss") & ")"
...
Private Sub fs_DatCre()
   ...
   Select Case g_rst_Princi!SOLMAE_TIPEVA
      Case 1:  grd_Listad(5).CellForeColor = modgen_g_con_ColAzu
      Case 2:  grd_Listad(5).CellForeColor = modgen_g_con_ColVer
      Case 3:  grd_Listad(5).CellForeColor = modgen_g_con_ColRoj
   End Select
...
Private Sub fs_Buscar_DatEva()
   ...
   grd_LisEva.Text = gf_FormatoNumero(g_rst_Princi!EVACRE_INGDP1, 12, 2)
   ...
   grd_LisEva.CellFontName = "Lucida Console"
   grd_LisEva.CellFontSize = 8
   grd_LisEva.Text = gf_FormatoNumero(g_rst_Princi!EVACRE_INGDP2, 12, 2)
   ...
   grd_LisEva.CellFontName = "Lucida Console"
   grd_LisEva.CellFontSize = 8
   grd_LisEva.Text = gf_FormatoNumero(g_rst_Princi!EVACRE_INGAD1, 12, 2)
   ...
   grd_LisEva.CellFontName = "Lucida Console"
   grd_LisEva.CellFontSize = 8
   grd_LisEva.Text = gf_FormatoNumero(g_rst_Princi!EVACRE_INGDP3, 12, 2)
   ...
   grd_LisEva.CellFontName = "Lucida Console"
   grd_LisEva.CellFontSize = 8
   grd_LisEva.Text = gf_FormatoNumero(g_rst_Princi!EVACRE_INGDP4, 12, 2)
   ...
   grd_LisEva.CellFontName = "Lucida Console"
   grd_LisEva.CellFontSize = 8
   grd_LisEva.Text = gf_FormatoNumero(g_rst_Princi!EVACRE_INGAD2, 12, 2)
   ...
   grd_LisEva.CellFontName = "Lucida Console"
   grd_LisEva.CellFontSize = 8
   grd_LisEva.Text = gf_FormatoNumero(g_rst_Princi!EVACRE_INGTOT, 12, 2)
