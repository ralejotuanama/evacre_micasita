   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel4 
         ...
         Begin VB.CommandButton cmd_LisRec 
            Height          =   675
            Left            =   30
            Picture         =   "EvaCre_frm_013.frx":000C
            Style           =   1  'Graphical
            TabIndex        =   20
            Top             =   30
            Width           =   675
         ...
         Begin VB.CommandButton cmd_Operac 
            Height          =   675
            Left            =   750
            Picture         =   "EvaCre_frm_013.frx":0316
            Style           =   1  'Graphical
            TabIndex        =   21
            Top             =   30
            Width           =   675
         ...
         Begin VB.CommandButton cmd_Acepta 
            Height          =   675
            Left            =   10140
            Picture         =   "EvaCre_frm_013.frx":0620
            Style           =   1  'Graphical
            TabIndex        =   23
         ...
         Begin VB.CommandButton cmd_ActEco 
            Height          =   675
            Left            =   9450
            Picture         =   "EvaCre_frm_013.frx":092A
            Style           =   1  'Graphical
            TabIndex        =   22
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   675
            Left            =   10830
            Picture         =   "EvaCre_frm_013.frx":0C34
            Style           =   1  'Graphical
            TabIndex        =   24
      ...
      Begin Threed.SSPanel SSPanel2 
         ...
         Begin VB.Image Image1 
            Height          =   540
            Left            =   60
            Picture         =   "EvaCre_frm_013.frx":1076
            Top             =   60
            Width           =   495
         End
      End
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.CommandButton cmd_Limpia 
            Height          =   675
            Left            =   10830
            Picture         =   "EvaCre_frm_013.frx":11ED
            Style           =   1  'Graphical
            TabIndex        =   3
            Top             =   60
            Width           =   675
         ...
         Begin VB.CommandButton cmd_Buscar 
            Height          =   675
            Left            =   10110
            Picture         =   "EvaCre_frm_013.frx":14F7
            Style           =   1  'Graphical
            TabIndex        =   2
            Top             =   60
            Width           =   675
...
Private Sub cmd_Acepta_Click()
   ...
   If cmb_ActEco.ItemData(cmb_ActEco.ListIndex) = 1 Then
      ...
      If modatecli_g_int_ActEcoCyg = 1 Then
         MsgBox "Debe registrar las Actividades Económicas del Cónyuge.", vbExclamation, modgen_g_con_AteCli
         Call gs_SetFocus(cmd_ActEco)
         Exit Sub
      End If
   End If
   ...
   If frm_MntCli_02.cmb_CodSex.ItemData(frm_MntCli_02.cmb_CodSex.ListIndex) = 1 Then
      modatecli_g_arr_DatGen(2).DatGen_CodSex = 2
   ElseIf frm_MntCli_02.cmb_CodSex.ItemData(frm_MntCli_02.cmb_CodSex.ListIndex) = 2 Then
...
Private Function ff_Valida() As Integer
   ...
   If (txt_NumDoc.Text = moddat_g_str_NumDoc) And (cmb_TipDoc.ItemData(cmb_TipDoc.ListIndex) = moddat_g_int_TipDoc) Then
      MsgBox "El Número de Documento de Identidad del Cónyuge es igual al del Titular.", vbExclamation, modgen_g_con_AteCli
      Call gs_SetFocus(txt_NumDoc)
      Exit Function
   End If
   ...
   If cmb_ActEco.ListIndex = -1 Then
      MsgBox "Debe seleccionar si el Cónyuge registra Actividad Económica.", vbExclamation, modgen_g_con_AteCli
      Call gs_SetFocus(cmb_ActEco)
      Exit Function
   End If
