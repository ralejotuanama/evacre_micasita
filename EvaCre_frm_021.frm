   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel5 
         ...
         Begin VB.CommandButton cmd_Cancel 
            Height          =   675
            Left            =   12000
            Picture         =   "EvaCre_frm_021.frx":000C
            Style           =   1  'Graphical
            TabIndex        =   3
         ...
         Begin VB.CommandButton cmd_Grabar 
            Height          =   675
            Left            =   11310
            Picture         =   "EvaCre_frm_021.frx":0316
            Style           =   1  'Graphical
            TabIndex        =   2
      ...
      Begin Threed.SSPanel SSPanel4 
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   675
            Left            =   12030
            Picture         =   "EvaCre_frm_021.frx":0758
            Style           =   1  'Graphical
            TabIndex        =   6
            ToolTipText     =   "Salir"
            Top             =   30
         ...
         Begin VB.CommandButton cmd_NueObs 
            Height          =   675
            Left            =   11340
            Picture         =   "EvaCre_frm_021.frx":0B9A
            Style           =   1  'Graphical
            TabIndex        =   5
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin Threed.SSPanel SSPanel7 
            ...
            _ExtentY        =   1085
            _StockProps     =   15
            Caption         =   "Observaciones de Evaluación Crediticia"
            ForeColor       =   32768
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   12
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "EvaCre_frm_021.frx":0FE4
            Top             =   60
            Width           =   480
         End
      End
...
Private Sub cmd_Grabar_Click()
   ...
   If Len(Trim(txt_Observ.Text)) = 0 Then
      MsgBox "Debe ingresar la Observación.", vbExclamation, modgen_g_con_AteCli
   ...
   If Not moddat_gf_Inserta_SegDet(moddat_g_str_NumSol, modatecli_g_con_EvaCre, 21, CStr(grd_LisObs.Rows + 1), txt_Observ.Text, 1, 0) Then
      Exit Sub
   End If
   
   'Actualizando en Instancia
   If Not moddat_gf_Modifica_Seguim(moddat_g_str_NumSol, modatecli_g_con_EvaCre, 0, 3, 2) Then
      Exit Sub
   End If
   ...
   MsgBox "Se genero la Observación a la Solicitud.", vbInformation, modgen_g_con_AteCli
End Sub

Private Sub cmd_NueObs_Click()
   If l_int_FlgDes = 2 Then
      MsgBox "No puede generar una Observación mientras la anterior no haya sido subsanada.", vbInformation, modgen_g_con_AteCli
      Call gs_SetFocus(grd_LisObs)
      Exit Sub
   End If
