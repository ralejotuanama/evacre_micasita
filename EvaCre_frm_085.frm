...
Begin VB.Form frm_Rpt_EvaCre_10 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin Threed.SSPanel pnl_Tit01 
            ...
            _ExtentY        =   503
            _StockProps     =   15
            Caption         =   "Reporte de Solicitudes Evaluadas"
            ForeColor       =   32768
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   8.25
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "EvaCre_frm_085.frx":000C
            Top             =   60
            Width           =   480
         End
      End
      Begin Threed.SSPanel SSPanel4 
         ...
         Begin VB.CommandButton cmd_Imprim 
            Height          =   585
            Left            =   30
            Picture         =   "EvaCre_frm_085.frx":0316
            Style           =   1  'Graphical
            TabIndex        =   5
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   7110
            Picture         =   "EvaCre_frm_085.frx":0758
            Style           =   1  'Graphical
            TabIndex        =   7
            ToolTipText     =   "Salir"
            Top             =   30
         ...
         Begin VB.CommandButton cmd_ExpExc 
            Height          =   585
            Left            =   630
            Picture         =   "EvaCre_frm_085.frx":0B9A
            Style           =   1  'Graphical
            TabIndex        =   6
   ...
   End
End
Attribute VB_Name = "frm_Rpt_EvaCre_10"
...
Dim r_int_TipRes     As Integer
   ...
   If moddat_g_int_TipPan = 1 Then
      ...
      Call modmip_gs_Exc_EvaSol(21, 1, r_str_Produc, r_int_TipRes, Format(CDate(ipp_FecIni.Text), "yyyymmdd"), Format(CDate(ipp_FecFin.Text), "yyyymmdd"), "")
      Screen.MousePointer = 0
  ElseIf moddat_g_int_TipPan = 2 Then
      'Reporte de Solicitudes Evaluadas - Consejero Hipotecario
      Screen.MousePointer = 11
      Call modmip_gs_Exc_EvaSol(21, 2, r_str_Produc, r_int_TipRes, Format(CDate(ipp_FecIni.Text), "yyyymmdd"), Format(CDate(ipp_FecFin.Text), "yyyymmdd"), "")
      Screen.MousePointer = 0
  ElseIf moddat_g_int_TipPan = 3 Then
      'Reporte de Solicitudes Evaluadas - Tipo de Evaluación Crediticia
      Screen.MousePointer = 11
      Call modmip_gs_Exc_EvaSol(21, 4, r_str_Produc, r_int_TipRes, Format(CDate(ipp_FecIni.Text), "yyyymmdd"), Format(CDate(ipp_FecFin.Text), "yyyymmdd"), "")
      Screen.MousePointer = 0
  ElseIf moddat_g_int_TipPan = 4 Then
      'Reporte de Solicitudes Evaluadas - Analista de Créditos
      Screen.MousePointer = 11
      Call modmip_gs_Exc_EvaSol(21, 5, r_str_Produc, r_int_TipRes, Format(CDate(ipp_FecIni.Text), "yyyymmdd"), Format(CDate(ipp_FecFin.Text), "yyyymmdd"), "")
      Screen.MousePointer = 0
  End If
...
Dim r_int_TipRes     As Integer
   ...
   If moddat_g_int_TipPan = 1 Then
      'Reporte de Solicitudes Evaluadas - Producto
      Screen.MousePointer = 11
      Call modmip_gs_Rpt_SolEva("CRE_EVAHIP_10.RPT", 1, r_str_Produc, 21, "", r_int_TipRes, ipp_FecIni.Text, ipp_FecFin.Text)
      Screen.MousePointer = 0
   ...
   ElseIf moddat_g_int_TipPan = 2 Then
      'Reporte de Solicitudes Evaluadas - Consejero Hipotecario
      Screen.MousePointer = 11
      Call modmip_gs_Rpt_SolEva("CRE_EVAHIP_11.RPT", 1, r_str_Produc, 21, "", r_int_TipRes, ipp_FecIni.Text, ipp_FecFin.Text)
      Screen.MousePointer = 0
      crp_Imprim.Connect = "DSN=" & moddat_g_str_NomEsq & "; UID=" & moddat_g_str_EntDat & "; PWD=" & moddat_g_str_ClaDat
      crp_Imprim.DataFiles(0) = "RPT_EVAHIP"
   ...
   ElseIf moddat_g_int_TipPan = 3 Then
      'Reporte de Solicitudes Evaluadas - Tipo de Evaluación Crediticia
      Screen.MousePointer = 11
      Call modmip_gs_Rpt_SolEva("CRE_EVAHIP_13.RPT", 4, r_str_Produc, 21, "", r_int_TipRes, ipp_FecIni.Text, ipp_FecFin.Text)
      Screen.MousePointer = 0
      crp_Imprim.Connect = "DSN=" & moddat_g_str_NomEsq & "; UID=" & moddat_g_str_EntDat & "; PWD=" & moddat_g_str_ClaDat
      crp_Imprim.DataFiles(0) = "RPT_EVAHIP"
...
Private Sub Form_Load()
   ...
   If moddat_g_int_TipPan = 1 Then
      'Reporte de Solicitudes Evaluadas - Producto
      pnl_Tit01.Caption = "Reporte de Solicitudes Evaluadas"
      pnl_Tit02.Caption = "Producto"
      pnl_Tit03.Caption = "Producto:"
      chk_Produc.Caption = "Todos los Productos"
   ...
   ElseIf moddat_g_int_TipPan = 2 Then
      ...
      chk_Produc.Caption = "Todos los Consejeros Hipotecarios"
      Call moddat_gs_Carga_EjecMC(cmb_Produc, l_arr_Produc, 121)
      Call moddat_gs_Carga_LisIte_Combo(cmb_TipRes, 1, "273")
   ElseIf moddat_g_int_TipPan = 3 Then
      'Reporte de Solicitudes Evaluadas - Tipo de Evaluación Crediticia
      pnl_Tit01.Caption = "Reporte de Solicitudes Evaluadas"
      pnl_Tit02.Caption = "Tipo de Evaluación Crediticia"
      pnl_Tit03.Caption = "Tipo Evaluación:"
      chk_Produc.Caption = "Todos los Tipos de Evaluación Crediticia"
      Call moddat_gs_Carga_LisIte_Combo(cmb_Produc, 1, "038")
      Call moddat_gs_Carga_LisIte_Combo(cmb_TipRes, 1, "273")
   ElseIf moddat_g_int_TipPan = 4 Then
      'Reporte de Solicitudes Evaluadas - Analista de Crédito
      pnl_Tit01.Caption = "Reporte de Solicitudes Evaluadas"
      pnl_Tit02.Caption = "Analista de Crédito"
      pnl_Tit03.Caption = "Analista de Crédito:"
      chk_Produc.Caption = "Todos los Tipos de Evaluación Crediticia"
      Call moddat_gs_Carga_EjecMC(cmb_Produc, l_arr_Produc, 211)
      Call moddat_gs_Carga_LisIte_Combo(cmb_TipRes, 1, "273")
   End If
