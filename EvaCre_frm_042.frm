...
Begin VB.Form frm_EvaCre_51 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel4 
         ...
         Begin TabDlg.SSTab tab_Seguim 
            ...
            TabPicture(0)   =   "EvaCre_frm_042.frx":000C
            ...
            TabPicture(1)   =   "EvaCre_frm_042.frx":0028
            ...
            TabPicture(2)   =   "EvaCre_frm_042.frx":0044
      ...
      Begin Threed.SSPanel SSPanel3 
         ...
         Begin TabDlg.SSTab SSTab1 
            ...
            TabPicture(6)   =   "EvaCre_frm_042.frx":011C
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin Threed.SSPanel SSPanel7 
            ...
            _ExtentY        =   873
            _StockProps     =   15
            Caption         =   "Créditos Hipotecarios - Evaluación Crediticia"
            ForeColor       =   32768
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   9.75
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "EvaCre_frm_042.frx":013C
            Top             =   60
            Width           =   480
         End
      End
      Begin Threed.SSPanel SSPanel36 
         ...
         Begin VB.CommandButton cmd_SolRec 
            Height          =   585
            Left            =   4230
            Picture         =   "EvaCre_frm_042.frx":0446
            Style           =   1  'Graphical
            TabIndex        =   72
         ...
         Begin VB.CommandButton cmd_LevCon 
            Height          =   585
            Left            =   2430
            Picture         =   "EvaCre_frm_042.frx":0750
            Style           =   1  'Graphical
            TabIndex        =   71
         ...
         Begin VB.CommandButton cmd_NueObs 
            Height          =   585
            Left            =   1230
            Picture         =   "EvaCre_frm_042.frx":0B92
            Style           =   1  'Graphical
            TabIndex        =   13
         ...
         Begin VB.CommandButton cmd_Excepc 
            Height          =   585
            Left            =   1830
            Picture         =   "EvaCre_frm_042.frx":0FD4
            Style           =   1  'Graphical
            TabIndex        =   12
         ...
         Begin VB.CommandButton cmd_AprCon 
            Height          =   585
            Left            =   4830
            Picture         =   "EvaCre_frm_042.frx":12DE
            Style           =   1  'Graphical
            TabIndex        =   11
         ...
         Begin VB.CommandButton cmd_Evalua 
            Height          =   585
            Left            =   630
            Picture         =   "EvaCre_frm_042.frx":15E8
            Style           =   1  'Graphical
            TabIndex        =   10
            ToolTipText     =   "Cálculo del Préstamo"
            Top             =   30
            Width           =   585
         End
         Begin VB.CommandButton cmd_CalIng 
            Height          =   585
            Left            =   30
            Picture         =   "EvaCre_frm_042.frx":18F2
            Style           =   1  'Graphical
            TabIndex        =   9
            ToolTipText     =   "Cálculo de Ingreso Líquido"
            Top             =   30
            Width           =   585
         End
         Begin VB.CommandButton cmd_DatCli 
            Height          =   585
            Left            =   3630
            Picture         =   "EvaCre_frm_042.frx":1BFC
            Style           =   1  'Graphical
            TabIndex        =   8
         ...
         Begin VB.CommandButton cmd_SimCre 
            Height          =   585
            Left            =   3030
            Picture         =   "EvaCre_frm_042.frx":1F06
            Style           =   1  'Graphical
            TabIndex        =   7
         ...
         Begin VB.CommandButton cmd_Rechaz 
            Height          =   585
            Left            =   6030
            Picture         =   "EvaCre_frm_042.frx":2210
            Style           =   1  'Graphical
            TabIndex        =   6
         ...
         Begin VB.CommandButton cmd_Aprueb 
            Height          =   585
            Left            =   5430
            Picture         =   "EvaCre_frm_042.frx":2652
            Style           =   1  'Graphical
            TabIndex        =   5
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   10920
            Picture         =   "EvaCre_frm_042.frx":295C
            Style           =   1  'Graphical
            TabIndex        =   4
            ToolTipText     =   "Salir"
            Top             =   30
   ...
   End
End
Attribute VB_Name = "frm_EvaCre_51"
...
Private Sub cmd_AprCon_Click()
   ...
   If Len(Trim(l_str_FecCal)) = 0 Then
      MsgBox "No se puede aprobar esta solicitud porque no se ha calculado el Monto de Préstamo a Aprobar.", vbExclamation, modgen_g_str_NomPlt
      Call gs_SetFocus(cmd_Evalua)
      Exit Sub
   End If
   ...
   modgen_g_str_Mail_Asunto = "EVALUACION CREDITICIA - APROBACION CONDICIONADA (" & Format(CDate(moddat_g_str_FecSis), "dd/mm/yyyy") & " - " & Format(Time, "hh:mm:ss") & ")"
...
Private Sub cmd_Aprueb_Click()
   ...
   'Enviando Correo Electrónico
   modgen_g_str_Mail_Asunto = "EVALUACION CREDITICIA - APROBACION (" & Format(CDate(moddat_g_str_FecSis), "dd/mm/yyyy") & " - " & Format(Time, "hh:mm:ss") & ")"
...
Private Sub cmd_Evalua_Click()
   If grd_LisEva.Rows = 0 Then
      MsgBox "Debe calcular el Total de Ingreso Neto del Cliente y/o su Cónyuge.", vbExclamation, modgen_g_str_NomPlt
      Call gs_SetFocus(cmd_CalIng)
      Exit Sub
   End If
...
Private Sub cmd_Excepc_Click()
   ...
   If moddat_g_int_FlgAct_1 = 2 Then
      ...
      'Enviando Correo Electrónico
      modgen_g_str_Mail_Asunto = "EVALUACION CREDITICIA - EXCEPCION (" & Format(CDate(moddat_g_str_FecSis), "dd/mm/yyyy") & " - " & Format(Time, "hh:mm:ss") & ")"
      ...
      Call fs_Envia_CorEle(modgen_g_str_Mail_Asunto, modgen_g_str_Mail_Mensaj, 3)
...
Private Sub cmd_LevCon_Click()
   ...
   If moddat_g_int_FlgAct_1 = 2 Then
      ...
      'Enviando Correo Electrónico
      modgen_g_str_Mail_Asunto = "EVALUACION CREDITICIA - LEVANTAMIENTO DE CONDICIONES DE APROBACION (" & Format(CDate(moddat_g_str_FecSis), "dd/mm/yyyy") & " - " & Format(Time, "hh:mm:ss") & ")"
...
Private Sub cmd_NueObs_Click()
   ...
   If moddat_g_int_FlgAct_1 = 2 Then
      ...
      If moddat_g_int_TipObs = 1 Then
         ...
         'Enviando Correo Electrónico
         modgen_g_str_Mail_Asunto = "EVALUACION CREDITICIA - OBSERVACION (" & Format(CDate(moddat_g_str_FecSis), "dd/mm/yyyy") & " - " & Format(Time, "hh:mm:ss") & ")"
...
Private Sub cmd_Rechaz_Click()
   ...
   If moddat_g_int_MotRec > 0 Then
      ...
      modgen_g_str_Mail_Asunto = "EVALUACION CREDITICIA - RECHAZO (" & Format(CDate(moddat_g_str_FecSis), "dd/mm/yyyy") & " - " & Format(Time, "hh:mm:ss") & ")"
...
Private Sub Form_Load()
   ...
   moddat_g_int_FlgActPri_Cli = 0
   moddat_g_int_FlgActSec_Cli = 0
   
   moddat_g_int_FlgActPri_Cyg = 0
   moddat_g_int_FlgActSec_Cyg = 0
...
Private Sub fs_Buscar_DatEva()
   ...
   grd_LisEva.Text = "Ingreso Cliente (Act. Principal)"
   
   grd_LisEva.Col = 1
   grd_LisEva.CellForeColor = modgen_g_con_ColNeg
   grd_LisEva.CellFontName = "Lucida Console"
   grd_LisEva.CellFontSize = 8
   grd_LisEva.Text = "S/. " & gf_FormatoNumero(g_rst_Princi!EVACRE_INGDP1, 12, 2)
   
   If g_rst_Princi!EVACRE_INGDP2 > 0 Then
      grd_LisEva.Rows = grd_LisEva.Rows + 1
      grd_LisEva.Row = grd_LisEva.Rows - 1
      grd_LisEva.Col = 0
      grd_LisEva.CellForeColor = modgen_g_con_ColNeg
      grd_LisEva.Text = "Ingreso Cliente (Act. Secundaria)"
      
      grd_LisEva.Col = 1
      grd_LisEva.CellForeColor = modgen_g_con_ColNeg
      grd_LisEva.CellFontName = "Lucida Console"
      grd_LisEva.CellFontSize = 8
      grd_LisEva.Text = "S/. " & gf_FormatoNumero(g_rst_Princi!EVACRE_INGDP2, 12, 2)
   End If
   
   If g_rst_Princi!EVACRE_INGAD1 > 0 Then
      grd_LisEva.Rows = grd_LisEva.Rows + 1
      grd_LisEva.Row = grd_LisEva.Rows - 1
      grd_LisEva.Col = 0
      grd_LisEva.CellForeColor = modgen_g_con_ColNeg
      grd_LisEva.Text = "Ingreso Cliente (Act. Adicional)"
      
      grd_LisEva.Col = 1
      grd_LisEva.CellForeColor = modgen_g_con_ColNeg
      grd_LisEva.CellFontName = "Lucida Console"
      grd_LisEva.CellFontSize = 8
      grd_LisEva.Text = "S/. " & gf_FormatoNumero(g_rst_Princi!EVACRE_INGAD1, 12, 2)
   End If
   ...
   If g_rst_Princi!EVACRE_INGDP3 > 0 Then
      ...
      grd_LisEva.Col = 0
      grd_LisEva.CellForeColor = modgen_g_con_ColNeg
      grd_LisEva.Text = "Ingreso Cónyuge (Act. Principal)"
      
      grd_LisEva.Col = 1
      grd_LisEva.CellForeColor = modgen_g_con_ColNeg
      grd_LisEva.CellFontName = "Lucida Console"
      grd_LisEva.CellFontSize = 8
      grd_LisEva.Text = "S/. " & gf_FormatoNumero(g_rst_Princi!EVACRE_INGDP3, 12, 2)
   End If
   
   If g_rst_Princi!EVACRE_INGDP4 > 0 Then
      grd_LisEva.Rows = grd_LisEva.Rows + 1
      grd_LisEva.Row = grd_LisEva.Rows - 1
      grd_LisEva.Col = 0
      grd_LisEva.CellForeColor = modgen_g_con_ColNeg
      grd_LisEva.Text = "Ingreso Cónyuge (Act. Secundaria)"
      
      grd_LisEva.Col = 1
      grd_LisEva.CellForeColor = modgen_g_con_ColNeg
      grd_LisEva.CellFontName = "Lucida Console"
      grd_LisEva.CellFontSize = 8
      grd_LisEva.Text = "S/. " & gf_FormatoNumero(g_rst_Princi!EVACRE_INGDP4, 12, 2)
   End If
   
   If g_rst_Princi!EVACRE_INGAD2 > 0 Then
      grd_LisEva.Rows = grd_LisEva.Rows + 1
      grd_LisEva.Row = grd_LisEva.Rows - 1
      grd_LisEva.Col = 0
      grd_LisEva.CellForeColor = modgen_g_con_ColNeg
      grd_LisEva.Text = "Ingreso Cónyuge (Act. Adicional)"
      
      grd_LisEva.Col = 1
      grd_LisEva.CellForeColor = modgen_g_con_ColNeg
      grd_LisEva.CellFontName = "Lucida Console"
      grd_LisEva.CellFontSize = 8
      grd_LisEva.Text = "S/. " & gf_FormatoNumero(g_rst_Princi!EVACRE_INGAD2, 12, 2)
   End If
   ...
   grd_LisEva.Col = 0
   grd_LisEva.CellForeColor = modgen_g_con_ColNeg
   grd_LisEva.Text = "Total Ingresos"
   
   grd_LisEva.Col = 1
   grd_LisEva.CellForeColor = modgen_g_con_ColNeg
   grd_LisEva.CellFontName = "Lucida Console"
   grd_LisEva.CellFontSize = 8
   grd_LisEva.Text = "S/. " & gf_FormatoNumero(g_rst_Princi!EVACRE_INGTOT, 12, 2)
   
   grd_LisEva.Rows = grd_LisEva.Rows + 1
   grd_LisEva.Row = grd_LisEva.Rows - 1
   grd_LisEva.Col = 0
   grd_LisEva.CellForeColor = modgen_g_con_ColNeg
   grd_LisEva.Text = "Obligaciones Mensuales"
   
   grd_LisEva.Col = 1
   grd_LisEva.CellForeColor = modgen_g_con_ColNeg
   grd_LisEva.CellFontName = "Lucida Console"
   grd_LisEva.CellFontSize = 8
   grd_LisEva.Text = "S/. " & gf_FormatoNumero(g_rst_Princi!EVACRE_OBLMEN, 12, 2)
   ...
   grd_LisEva.CellFontName = "Lucida Console"
   grd_LisEva.CellFontSize = 8
   grd_LisEva.Text = "S/. " & gf_FormatoNumero(g_rst_Princi!EVACRE_MTODEU, 12, 2)
   ...
   If moddat_g_int_TipMon <> 1 Then
      ...
      grd_LisEva.Col = 0
      grd_LisEva.CellForeColor = modgen_g_con_ColNeg
      grd_LisEva.Text = "Tipo Cambio (Cálculo Ingresos)"
   ...
   grd_LisEva.Col = 0
   grd_LisEva.CellForeColor = modgen_g_con_ColNeg
   grd_LisEva.Text = "Fecha Cálculo de Ingresos"
   
   grd_LisEva.Col = 1
   grd_LisEva.CellForeColor = modgen_g_con_ColNeg
   grd_LisEva.CellFontName = "Lucida Console"
   grd_LisEva.CellFontSize = 8
   grd_LisEva.Text = gf_FormatoFecha(CStr(g_rst_Princi!EVACRE_FECING))
   ...
   If g_rst_Princi!EVACRE_FECCAL > 0 Then
      ...
      grd_LisEva.Col = 0
      grd_LisEva.CellForeColor = modgen_g_con_ColRoj
      grd_LisEva.Text = "Fecha de Aprobación de Cuota"
      
      grd_LisEva.Col = 1
      grd_LisEva.CellForeColor = modgen_g_con_ColRoj
      grd_LisEva.CellFontName = "Lucida Console"
      grd_LisEva.CellFontSize = 8
      grd_LisEva.Text = gf_FormatoFecha(CStr(g_rst_Princi!EVACRE_FECCAL))
   End If
...
Private Sub fs_Envia_CorEle(ByVal p_Asunto As String, ByVal p_Mensaje As String, ByVal p_FlgApr As Integer)
   Dim r_str_Cadena     As String
   ...
   If Not moddat_gf_Verifica_DirEle(moddat_g_arr_Genera, moddat_gf_Buscar_DirEle_Codigo(moddat_g_str_CodConHip)) Then
      ReDim Preserve moddat_g_arr_Genera(UBound(moddat_g_arr_Genera) + 1)
