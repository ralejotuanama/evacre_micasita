...
Begin VB.Form frm_EvaCre_52 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel2 
         ...
         End
         Begin VB.Label lbl_Etique 
            Caption         =   "Ingreso Líquido Cónyuge:"
            Height          =   315
            Index           =   15
            Left            =   60
            TabIndex        =   55
      ...
      Begin Threed.SSPanel SSPanel5 
         ...
         Begin VB.Label Label9 
            Caption         =   "Total Ingreso Líquido Neto:"
            Height          =   315
            Left            =   60
            TabIndex        =   10
            Top             =   60
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin Threed.SSPanel pnl_TitSec 
            ...
            _ExtentY        =   556
            _StockProps     =   15
            Caption         =   "Registro de Ingreso Líquido Depurado"
            ForeColor       =   32768
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   9.75
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "EvaCre_frm_045.frx":000C
            Top             =   60
            Width           =   480
         End
      End
      Begin Threed.SSPanel SSPanel4 
         ...
         Begin VB.CommandButton cmd_Recalc 
            Height          =   585
            Left            =   1230
            Picture         =   "EvaCre_frm_045.frx":0316
            Style           =   1  'Graphical
            TabIndex        =   62
         ...
         Begin VB.CommandButton cmd_Grabar 
            Height          =   585
            Left            =   1830
            Picture         =   "EvaCre_frm_045.frx":0758
            Style           =   1  'Graphical
            TabIndex        =   24
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   10560
            Picture         =   "EvaCre_frm_045.frx":0B9A
            Style           =   1  'Graphical
            TabIndex        =   23
            ToolTipText     =   "Salir"
            Top             =   30
         ...
         Begin VB.CommandButton cmd_SimCre 
            Height          =   585
            Left            =   30
            Picture         =   "EvaCre_frm_045.frx":0FDC
            Style           =   1  'Graphical
            TabIndex        =   22
         ...
         Begin VB.CommandButton cmd_Calcul 
            Height          =   585
            Left            =   630
            Picture         =   "EvaCre_frm_045.frx":12E6
            Style           =   1  'Graphical
            TabIndex        =   21
            ToolTipText     =   "Salir"
            Top             =   30
      ...
      Begin Threed.SSPanel SSPanel8 
         ...
         End
         Begin VB.Label lbl_Etique 
            Caption         =   "Ingreso Líquido Cliente:"
            Height          =   315
            Index           =   11
            Left            =   60
            TabIndex        =   48
   ...
   End
End
Attribute VB_Name = "frm_EvaCre_52"
...
Private Sub cmd_Recalc_Click()
   If MsgBox("¿Está seguro de recalcular los datos ?", vbQuestion + vbDefaultButton2 + vbYesNo, modgen_g_str_NomPlt) <> vbYes Then
      Exit Sub
   End If
...
Private Sub fs_DatCre()
   ...
   If g_rst_Princi!SOLMAE_COMVTA_MON > 0 Then
      If g_rst_Princi!SOLMAE_TIPMON = 2 Then
         ...
         grd_Listad(5).Text = moddat_gf_Consulta_ParDes("229", g_rst_Princi!SOLMAE_TIPMON) & " " & gf_FormatoNumero(g_rst_Princi!SOLMAE_COMVTA_DOL, 12, 2)
         ...
         grd_Listad(5).CellFontName = "Lucida Console"
         grd_Listad(5).CellFontSize = 8
         grd_Listad(5).Text = moddat_gf_Consulta_ParDes("229", g_rst_Princi!SOLMAE_TIPMON) & " " & gf_FormatoNumero(g_rst_Princi!SOLMAE_APOPRO_DOL, 12, 2)
         ...
         grd_Listad(5).CellFontName = "Lucida Console"
         grd_Listad(5).CellFontSize = 8
         grd_Listad(5).Text = moddat_gf_Consulta_ParDes("229", g_rst_Princi!SOLMAE_TIPMON) & " " & gf_FormatoNumero(g_rst_Princi!SOLMAE_MTOPRE_DOL, 12, 2)
      Else
         grd_Listad(5).Rows = grd_Listad(5).Rows + 1
         grd_Listad(5).Row = grd_Listad(5).Rows - 1
         grd_Listad(5).Col = 0
         ...
         grd_Listad(5).CellFontName = "Lucida Console"
         grd_Listad(5).CellFontSize = 8
         grd_Listad(5).Text = moddat_gf_Consulta_ParDes("229", g_rst_Princi!SOLMAE_TIPMON) & " " & gf_FormatoNumero(g_rst_Princi!SOLMAE_COMVTA_SOL, 12, 2)
         ...
         grd_Listad(5).CellFontName = "Lucida Console"
         grd_Listad(5).CellFontSize = 8
         grd_Listad(5).Text = moddat_gf_Consulta_ParDes("229", g_rst_Princi!SOLMAE_TIPMON) & " " & gf_FormatoNumero(g_rst_Princi!SOLMAE_APOPRO_SOL, 12, 2)
         ...
         grd_Listad(5).CellFontName = "Lucida Console"
         grd_Listad(5).CellFontSize = 8
         grd_Listad(5).Text = moddat_gf_Consulta_ParDes("229", g_rst_Princi!SOLMAE_TIPMON) & " " & gf_FormatoNumero(g_rst_Princi!SOLMAE_MTOPRE_SOL, 12, 2)
      End If
...
Private Sub fs_Buscar_DatEva()
   ...
   'l_dbl_TipCam = g_rst_Princi!EVACRE_TCAING
   'pnl_TipCam.Caption = Format(g_rst_Princi!EVACRE_TCAING, "###,##0.0000") & " "
