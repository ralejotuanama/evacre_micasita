...
Begin VB.Form frm_Rpt_EvaCre_08 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin Threed.SSPanel pnl_Tit01 
            ...
            _ExtentY        =   503
            _StockProps     =   15
            Caption         =   "Reporte de Solicitudes con Excepción en Evaluación Crediticia"
            ForeColor       =   32768
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   8.25
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "EvaCre_frm_081.frx":000C
            Top             =   60
            Width           =   480
         End
      End
      Begin Threed.SSPanel SSPanel4 
         ...
         Begin VB.CommandButton cmd_ExpExc 
            Height          =   585
            Left            =   630
            Picture         =   "EvaCre_frm_081.frx":0316
            Style           =   1  'Graphical
            TabIndex        =   5
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   7110
            Picture         =   "EvaCre_frm_081.frx":0620
            Style           =   1  'Graphical
            TabIndex        =   6
            ToolTipText     =   "Salir"
            Top             =   30
         ...
         Begin VB.CommandButton cmd_Imprim 
            Height          =   585
            Left            =   30
            Picture         =   "EvaCre_frm_081.frx":0A62
            Style           =   1  'Graphical
            TabIndex        =   4
   ...
   End
End
Attribute VB_Name = "frm_Rpt_EvaCre_08"
...
Private Sub Form_Load()
   ...
   If moddat_g_int_TipPan = 1 Then
      'Reporte de Solicitudes con Excepción en Evaluación Crediticia - Producto
      pnl_Tit01.Caption = "Reporte de Solicitudes con Excepción en Evaluación Crediticia"
   ...
   ElseIf moddat_g_int_TipPan = 2 Then
      'Reporte de Solicitudes con Excepción en Evaluación Crediticia - Consejero Hipotecario
      pnl_Tit01.Caption = "Reporte de Solicitudes con Excepción en Evaluación Crediticia"
...
Private Sub cmd_ExpExc_Click()
   ...
   If moddat_g_int_TipPan = 1 Then
      'Reporte de Solicitudes con Excepción en Evaluación Crediticia - Producto
      If chk_Produc.Value = 0 Then
         Call modmip_gs_Exc_ExcEva(21, 1, l_arr_Produc(cmb_Produc.ListIndex + 1).Genera_Codigo, Format(CDate(ipp_FecIni.Text), "yyyymmdd"), Format(CDate(ipp_FecFin.Text), "yyyymmdd"))
      Else
         Call modmip_gs_Exc_ExcEva(21, 1, "", Format(CDate(ipp_FecIni.Text), "yyyymmdd"), Format(CDate(ipp_FecFin.Text), "yyyymmdd"))
      End If
   ElseIf moddat_g_int_TipPan = 2 Then
      'Reporte de Solicitudes con Excepción en Evaluación Crediticia - Consejero Hipotecario
      If chk_Produc.Value = 0 Then
         Call modmip_gs_Exc_ExcEva(21, 2, l_arr_Produc(cmb_Produc.ListIndex + 1).Genera_Codigo, Format(CDate(ipp_FecIni.Text), "yyyymmdd"), Format(CDate(ipp_FecFin.Text), "yyyymmdd"))
      Else
         Call modmip_gs_Exc_ExcEva(21, 2, "", Format(CDate(ipp_FecIni.Text), "yyyymmdd"), Format(CDate(ipp_FecFin.Text), "yyyymmdd"))
      End If
   End If
...
Private Sub cmd_Imprim_Click()
   ...
   If moddat_g_int_TipPan = 1 Then
      ...
      crp_Imprim.SelectionFormula = "{TRA_SEGEXC.SEGEXC_CODINS} = 21 AND "
      If chk_Produc.Value = 0 Then
   ...
   ElseIf moddat_g_int_TipPan = 2 Then
      ...
      crp_Imprim.SelectionFormula = "{TRA_SEGEXC.SEGEXC_CODINS} = 21 AND "
      If chk_Produc.Value = 0 Then
         crp_Imprim.SelectionFormula = crp_Imprim.SelectionFormula & "{CRE_SOLMAE.SOLMAE_CONHIP} = '" & l_arr_Produc(cmb_Produc.ListIndex + 1).Genera_Codigo & "' AND "
      End If
      crp_Imprim.SelectionFormula = crp_Imprim.SelectionFormula & "{TRA_SEGEXC.SEGFECCRE} >= " & Format(CDate(ipp_FecIni.Text), "yyyymmdd") & " AND "
      crp_Imprim.SelectionFormula = crp_Imprim.SelectionFormula & "{TRA_SEGEXC.SEGFECCRE} <= " & Format(CDate(ipp_FecFin.Text), "yyyymmdd")
      'Se pone la llamada del nombre del reporte y se escoge donde se destinara el reporte
