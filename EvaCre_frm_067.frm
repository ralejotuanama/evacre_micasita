...
Begin VB.Form frm_EvaCre_61 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel2 
         ...
         Begin VB.CommandButton cmd_EvaCre 
            Height          =   585
            Left            =   30
            Picture         =   "EvaCre_frm_067.frx":000C
            Style           =   1  'Graphical
            TabIndex        =   1
            Top             =   30
            Width           =   585
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   13410
            Picture         =   "EvaCre_frm_067.frx":08D6
            Style           =   1  'Graphical
            TabIndex        =   2
            ToolTipText     =   "Salir"
            Top             =   30
      ...
      Begin Threed.SSPanel SSPanel3 
         ...
         Begin Threed.SSPanel pnl_Tit_IngIns 
            ...
            Outline         =   -1  'True
         End
         Begin Threed.SSPanel pnl_Tit_Evalua 
            Height          =   285
            Left            =   12480
            TabIndex        =   17
            Top             =   60
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "EvaCre_frm_067.frx":0D18
            Top             =   60
            Width           =   480
         End
      End
   End
End
Attribute VB_Name = "frm_EvaCre_61"
...
Private Sub fs_Inicia()
   ...
   grd_Listad.ColWidth(0) = 1860
   grd_Listad.ColWidth(1) = 1360
   grd_Listad.ColWidth(2) = 975
   grd_Listad.ColWidth(3) = 3390
   grd_Listad.ColWidth(4) = 990
   grd_Listad.ColWidth(5) = 990
   grd_Listad.ColWidth(6) = 1540
   grd_Listad.ColWidth(7) = 1290
   grd_Listad.ColWidth(8) = 0
   grd_Listad.ColWidth(9) = 0
   grd_Listad.ColWidth(10) = 0
   grd_Listad.ColWidth(11) = 0
   grd_Listad.ColWidth(12) = 0
   grd_Listad.ColWidth(13) = 1200
...
Private Sub fs_Buscar()
   ...
   g_str_Parame = g_str_Parame & "   AND SOLMAE_CODINS = 21 "
   ...
   If Not (g_rst_Princi.BOF And g_rst_Princi.EOF) Then
      ...
      Do While Not g_rst_Princi.EOF
         ...
         g_str_Parame = ""
         g_str_Parame = g_str_Parame & "SELECT SEGUIM_FECINI, SEGUIM_SITUAC, SEGUSUCRE "
         g_str_Parame = g_str_Parame & "  FROM TRA_SEGUIM "
         ...
         If Not (g_rst_Genera.BOF And g_rst_Genera.EOF) Then
            ...
            grd_Listad.Col = 13
            If Not IsNull(g_rst_Genera!SEGUSUCRE) Then
               grd_Listad.Text = Trim(g_rst_Genera!SEGUSUCRE)
            End If
         End If
...
Private Sub pnl_Tit_Evalua_Click()
   If Len(Trim(pnl_Tit_Evalua.Tag)) = 0 Or pnl_Tit_Evalua.Tag = "D" Then
      pnl_Tit_Evalua.Tag = "A"
      Call gs_SorteaGrid(grd_Listad, 13, "C")
   Else
      pnl_Tit_Evalua.Tag = "D"
      Call gs_SorteaGrid(grd_Listad, 13, "C-")
   End If
End Sub
